...
if __name__ == '__main__':
    ...
    parser.add_argument('--full', dest='full_audio', help='analyze full audio instead of a centered 29.1s segment',
                        action='store_true')
    #
    # #########~~ARGUMENTS ADDED BY ME --- DELETE LATER ################
    # parser.add_argument('numBands', help='number of bands')
    # parser.add_argument('frameSize', help='frame size')
    # parser.add_argument('hopSize', help='hop size')
